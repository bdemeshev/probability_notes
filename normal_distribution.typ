...
Упражнение. Придумайте вектор с ожиданиями $EE(Y_i) = m_i$ и ковариацией $Cov(Y_i, Y_j) = c_(i j)$, для которого полученная формула не верна. 
...
Это, конечно, немножко ожидаемо, если вспомнить про размерности. 
...
В-четвертых, в индексах каждого слагаемого правой части упомянуты ровно по одному разу все индексы из левой части. Например, для $EE(Y_1 Y_2 Y_3)$ каждое слагаемое содержит в индексе одну единицу, одну двойку и одну тройку. 
...
Доказательство отсутствия дисперсии. 
